...
function describeEvent(event: GameEvent, payload: Record<string, unknown>, context: GameContext) {
  ...
  const labels: Record<string, string> = {
    ...
    "comrade.request_responded": "合作回应", "comrade.commitment_confirmed": "确认合作", "comrade.request_cancelled": "撤回合作",
    "comrade.task_completed": "同志行动完成", "comrade.task_failed": "同志行动受挫", "character.recruited": "正式招募",
