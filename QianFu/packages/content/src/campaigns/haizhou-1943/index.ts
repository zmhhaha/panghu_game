...
const draft: CampaignDefinition = {
  ...
  coverProfiles: {
    archive_clerk: {
      title: "港务凭证核验员",
      summary: "在港务档案室核对船票、封签与交接凭证；每次外出都要能由调阅记录说明。",
      routineLabel: "船票与封签核验",
      startingLocationId: "harbor-records",
      workLocationIds: ["harbor-records"],
      initialContactCharacterIds: ["xu-tingzhou"],
    },
    travelling_merchant: {
      title: "码头药材经纪人",
      summary: "替药行和货栈撮合进货、验货与结账；你的公开行踪必须留下货单、客户和船期记录。",
      routineLabel: "货单与客户往来",
      startingLocationId: "yongtai-trading",
      workLocationIds: ["yongtai-trading"],
      initialContactCharacterIds: ["he-jinshun"],
    },
    freelance_writer: {
      title: "晨报外勤采编",
      summary: "负责采访、核稿和追踪地方消息；你的活动范围必须能由编辑约稿和采风记录解释。",
      routineLabel: "采访与编辑交稿",
      startingLocationId: "haizhou-morning",
      workLocationIds: ["haizhou-morning"],
      initialContactCharacterIds: ["qiao-yunshu"],
    },
  },
  locations,
  characters,
