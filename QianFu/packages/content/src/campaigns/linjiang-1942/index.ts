...
const draft: CampaignDefinition = {
  ...
  publicLeads: [
    ...
    {
      id: "merchant-news-introduction",
      trigger: "dialogue_discovery",
      profileIds: ["travelling_merchant"],
      characterId: "luo-boan",
      locationIds: ["linjiang-news"],
      characterIds: ["lin-ruolan"],
      hint: "罗伯安建议从日报的公开商情栏核对来客与货运日程，编辑林若岚负责整理这类公开消息。",
    },
    {
      id: "archive-hotel-register-introduction",
      trigger: "dialogue_discovery",
      profileIds: ["archive_clerk"],
      characterId: "chen-jingwen",
      locationIds: ["jianghai-hotel"],
      characterIds: ["luo-boan"],
      hint: "陈敬文提到一份借阅记录需要与饭店来客簿核对，商会秘书罗伯安可以公开说明会面日程。",
    },
    {
      id: "archive-radio-maintenance-introduction",
      trigger: "dialogue_discovery",
      profileIds: ["travelling_merchant", "freelance_writer"],
      characterId: "chen-jingwen",
      locationIds: ["radio-office"],
      characterIds: ["zhou-qiming"],
      hint: "陈敬文让你按公开流程向电讯科核对设备维修编号，技术员周启明是登记的经办人。",
    },
    {
      id: "dock-clock-parts-introduction",
      trigger: "dialogue_discovery",
      profileIds: ["archive_clerk", "freelance_writer"],
      characterId: "zhao-fusheng",
      locationIds: ["wu-clock-shop"],
      characterIds: ["old-wu"],
      hint: "赵福生说一批精密零件的公开收货回执由旧城钟表店留存，店主老吴可以核对订单。",
    },
    {
      id: "news-security-circular-introduction",
      trigger: "dialogue_discovery",
      profileIds: ["travelling_merchant", "freelance_writer"],
      characterId: "lin-ruolan",
      locationIds: ["archive-office"],
      characterIds: ["han-shijie"],
      hint: "林若岚提到近期公开治安通报由警备处调查员韩世杰经办；如需核对原件，可按公开手续前往档案科。",
    },
    {
